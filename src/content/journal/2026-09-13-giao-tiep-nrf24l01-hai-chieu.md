---
title: "Thiết kế giao tiếp nRF24L01 hai chiều"
researchDate: 2026-09-13
publishedDate: 2026-08-28
authors:
  - "Lê Quang Minh"
  - "Vũ Tuệ Phương"
summary: "Kế hoạch nhật ký ngày 13/09/2026. Chỉ chuyển sang hoàn thành sau khi bổ sung dữ liệu và minh chứng thực tế."
activityTypes:
  - "dien-tu"
  - "lap-trinh"
status: "planned"
...
- Chốt cấu trúc gói dữ liệu.
- Phân biệt dữ liệu đo, trạng thái, lỗi và cấu hình.
- Thiết kế xác nhận, thử lại và chống ghi trùng.

## Cơ sở và nội dung dự kiến

Thiết bị hiện trường gửi kết quả và trạng thái về Raspberry Pi; Raspberry Pi gửi ngược chu kỳ đo và số lần thu nhận. Mất liên kết không được làm dừng chức năng đo tại chỗ.
...
- [ ] Định nghĩa trường packet ID và timestamp.
- [ ] Thử gửi nhận ở khoảng cách ngắn.
- [ ] Thử mất gói và gửi lại.
- [ ] Kiểm tra thay đổi cấu hình hai chiều.
- [ ] Ghi tỷ lệ truyền thành công trong điều kiện thử.
...
- [ ] Định dạng packet.
- [ ] Log gửi–nhận.
- [ ] Ảnh hai mô-đun và bố trí thử.
- [ ] Bảng kết quả khoảng cách/mất gói.

## Công việc tiếp theo

Xây dựng giao diện Raspberry Pi để theo dõi và cấu hình.
