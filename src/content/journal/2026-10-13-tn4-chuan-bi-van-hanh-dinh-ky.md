---
title: "Thí nghiệm 4 – Chuẩn bị vận hành định kỳ"
researchDate: 2026-10-13
publishedDate: 2026-08-28
authors:
  - "Lê Quang Minh"
  - "Vũ Tuệ Phương"
summary: "Kế hoạch nhật ký ngày 13/10/2026. Chỉ chuyển sang hoàn thành sau khi bổ sung dữ liệu và minh chứng thực tế."
activityTypes:
  - "thi-nghiem"
status: "planned"
experimentIds:
...
- Chuẩn bị mẫu ổn định và KCl.
- Kiểm tra toàn bộ cơ cấu và truyền dữ liệu.
- Chốt điều kiện không thay tham số trong khi thử.

## Cơ sở và nội dung dự kiến

TN4 sử dụng bộ tham số đã khóa để đánh giá toàn hệ thống qua tối thiểu 50 chu trình, hướng tới 100 chu trình hoặc nhiều ngày nếu điều kiện cho phép.
...
- [ ] Đo pH/nhiệt độ tham chiếu ban đầu.
- [ ] Kiểm tra KCl, bơm, van, cánh tay, cảm biến và nRF24L01.
- [ ] Kiểm tra file lưu dữ liệu.
- [ ] Cấu hình chu kỳ và bộ tham số TN3.
- [ ] Chuẩn bị sổ ghi sự kiện bất thường.
...
- [ ] Checklist trước vận hành.
- [ ] Ảnh hệ thống hoàn chỉnh.
- [ ] Ảnh màn hình cấu hình.
- [ ] Bản sao file dữ liệu trống/header.

## Công việc tiếp theo

Bắt đầu chuỗi vận hành 50–100 chu trình.
