---
title: "Xây dựng câu hỏi nghiên cứu và tiêu chí đánh giá"
researchDate: 2026-08-26
publishedDate: 2026-08-28
authors:
  - "Lê Quang Minh"
  - "Vũ Tuệ Phương"
summary: "Kế hoạch nhật ký ngày 26/08/2026. Chỉ chuyển sang hoàn thành sau khi bổ sung dữ liệu và minh chứng thực tế."
activityTypes:
  - "phan-tich"
  - "bao-cao"
status: "planned"
...
- Chốt bốn nhóm thí nghiệm.
- Xác định các đại lượng E, D và tỷ lệ chu trình hoàn thành.
- Liên kết mỗi câu hỏi nghiên cứu với minh chứng cần thu.

## Cơ sở và nội dung dự kiến

Hệ thống cần được đánh giá tách biệt theo sai số phép đo, ảnh hưởng lấy mẫu, thông số vận hành và khả năng hoàn thành chu trình tự động.
...
- [ ] Xây dựng ma trận mục tiêu–thí nghiệm–chỉ tiêu.
- [ ] Quy định số lần lặp tối thiểu.
- [ ] Chốt thiết bị tham chiếu và cách ghi nhiệt độ.
- [ ] Lập nguyên tắc không loại bỏ chu trình lỗi.
...
- [ ] Danh sách chỉ tiêu đánh giá.
- [ ] Bản dự thảo bốn thí nghiệm.

## Công việc tiếp theo

Chi tiết hóa kiến trúc thiết bị hiện trường và khối Raspberry Pi.
